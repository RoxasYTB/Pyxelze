...
- Le nettoyage a été effectué en plusieurs étapes : suppression de dossiers, suppression par patterns (_.exe, _.zip), puis `git-filter-repo --strip-blobs-bigger-than 5M` pour garantir l'élimination des blobs volumineux.
